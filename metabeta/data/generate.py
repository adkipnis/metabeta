...
def setup() -> argparse.Namespace:
    ...
    parser.add_argument('--max_m', type=int, default=50, help='Maximum number of groups (default = 50).')
    parser.add_argument('--min_n', type=int, default=10, help='Minimum number of samples per group (default = 10).')
    parser.add_argument('--max_n', type=int, default=100, help='Maximum number of samples per group (default = 100).')
