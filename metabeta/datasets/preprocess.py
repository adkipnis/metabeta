...
TEST_GROUP_WHITELIST: set[tuple[str, str, str]] = {
    ...
    ('from-r', 'arabidopsis', 'group'),
    ('from-r', 'bacteria', 'group'),
    ('from-r', 'cane', 'group'),
    ('from-r', 'epil', 'group'),
    ('from-r', 'guimmun', 'group'),
    ('from-r', 'guprenat', 'group'),
    ('from-r', 'mmmec', 'group'),
    ('from-r', 'muscatine', 'group'),
    ('from-r', 'ohio', 'group'),
    ('from-r', 'ome', 'group'),
    ('from-r', 'owls', 'group'),
    ('from-r', 'respinf', 'group'),
    ('from-r', 'respiratory', 'group'),
    ('from-r', 'salamanders', 'group'),
