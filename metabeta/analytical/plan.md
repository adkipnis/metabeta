...
- [plan_bernoulli.md](plan_bernoulli.md) — Bernoulli GLMM: PQL+P5+P6+BC1 baseline, open priorities P3–P4 (beta blend, blup_var), CAVI reference results through large/huge.
