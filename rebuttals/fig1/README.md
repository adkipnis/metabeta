...
Modeling assumption: $y \sim Bernoulli(sigmoid(\eta))$ with $\eta_i = X\beta + Z_i \alpha_i$. Training was performed on the [small model config](../../metabeta/models/configs/small.yaml).  No importance sampling or conformal prediction applied.
