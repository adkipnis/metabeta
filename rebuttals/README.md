...
| ID | Content | Referenced in |
|---|---|---|
| [R-Fig. 1](fig1) | Bernoulli model performance (logistic link function)| Response 6RHU (point 1.1) |
| R-Fig. 2 | Poisson model performance (log link function) | Response 6RHU (point 1.1) |
