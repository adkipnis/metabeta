...
Systematic runtime comparison of metabeta, NUTS, and ADVI across 2000+ simulated datasets spanning the full range of $d$, $q$, $m$, and $n$ covered by the model configs (small, mid, medium, big, large).
...
3. NUTS and ADVI runtimes are read directly from the pre-fitted test files (produced by `metabeta/simulation/fit.py` using bambi/pymc).
